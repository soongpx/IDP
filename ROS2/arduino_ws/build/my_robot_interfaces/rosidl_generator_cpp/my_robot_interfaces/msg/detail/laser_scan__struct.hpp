...
#ifndef MY_ROBOT_INTERFACES__MSG__DETAIL__LASER_SCAN__STRUCT_HPP_
#define MY_ROBOT_INTERFACES__MSG__DETAIL__LASER_SCAN__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__my_robot_interfaces__msg__LaserScan __attribute__((deprecated))
#else
# define DEPRECATED__my_robot_interfaces__msg__LaserScan __declspec(deprecated)
#endif
...
struct LaserScan_
{
  ...
  // pointer types
  using RawPtr =
    my_robot_interfaces::msg::LaserScan_<ContainerAllocator> *;
  using ConstRawPtr =
    const my_robot_interfaces::msg::LaserScan_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<my_robot_interfaces::msg::LaserScan_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<my_robot_interfaces::msg::LaserScan_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      my_robot_interfaces::msg::LaserScan_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<my_robot_interfaces::msg::LaserScan_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<my_robot_interfaces::msg::LaserScan_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<my_robot_interfaces::msg::LaserScan_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<my_robot_interfaces::msg::LaserScan_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__my_robot_interfaces__msg__LaserScan
    std::shared_ptr<my_robot_interfaces::msg::LaserScan_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__my_robot_interfaces__msg__LaserScan
    std::shared_ptr<my_robot_interfaces::msg::LaserScan_<ContainerAllocator> const>
...
using LaserScan =
  my_robot_interfaces::msg::LaserScan_<std::allocator<void>>;
...
#endif  // MY_ROBOT_INTERFACES__MSG__DETAIL__LASER_SCAN__STRUCT_HPP_
