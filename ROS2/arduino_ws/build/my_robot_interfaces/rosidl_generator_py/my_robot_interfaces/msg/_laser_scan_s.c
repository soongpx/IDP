...
bool my_robot_interfaces__msg__laser_scan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces.msg._laser_scan.LaserScan", full_classname_dest, 45) == 0);
  }
  my_robot_interfaces__msg__LaserScan * ros_message = _ros_message;
  {  // header
...
PyObject * my_robot_interfaces__msg__laser_scan__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.msg._laser_scan");
