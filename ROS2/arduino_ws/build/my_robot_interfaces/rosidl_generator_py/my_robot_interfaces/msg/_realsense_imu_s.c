...
bool my_robot_interfaces__msg__realsense_imu__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_robot_interfaces.msg._realsense_imu.RealsenseImu", full_classname_dest, 51) == 0);
  }
  my_robot_interfaces__msg__RealsenseImu * ros_message = _ros_message;
  {  // pitch
...
{
  /* NOTE(esteve): Call constructor of RealsenseImu */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_robot_interfaces.msg._realsense_imu");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RealsenseImu");
