...
{
  new (message_memory) my_robot_interfaces::msg::LidarScan(_init);
}

void LidarScan_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_robot_interfaces::msg::LidarScan *>(message_memory);
...
void fetch_function__LidarScan__angle(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__LidarScan__angle(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__LidarScan__angle(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__LidarScan__angle(untyped_member, index));
...
void fetch_function__LidarScan__range(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const double *>(
    get_const_function__LidarScan__range(untyped_member, index));
  auto & value = *reinterpret_cast<double *>(untyped_value);
  value = item;
}

void assign_function__LidarScan__range(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<double *>(
    get_function__LidarScan__range(untyped_member, index));
  const auto & value = *reinterpret_cast<const double *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember LidarScan_message_member_array[3] = {
  {
    "detected",  // name
    ...
    offsetof(my_robot_interfaces::msg::LidarScan, detected),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::msg::LidarScan, angle),  // bytes offset in struct
    nullptr,  // default value
    ...
    fetch_function__LidarScan__angle,  // fetch(index, &value) function pointer
    assign_function__LidarScan__angle,  // assign(index, value) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_robot_interfaces::msg::LidarScan, range),  // bytes offset in struct
    nullptr,  // default value
    ...
    fetch_function__LidarScan__range,  // fetch(index, &value) function pointer
    assign_function__LidarScan__range,  // assign(index, value) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers LidarScan_message_members = {
  ...
  3,  // number of fields
  sizeof(my_robot_interfaces::msg::LidarScan),
...
get_message_type_support_handle<my_robot_interfaces::msg::LidarScan>()
{
  return &::my_robot_interfaces::msg::rosidl_typesupport_introspection_cpp::LidarScan_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_robot_interfaces, msg, LidarScan)() {
  return &::my_robot_interfaces::msg::rosidl_typesupport_introspection_cpp::LidarScan_message_type_support_handle;
}
