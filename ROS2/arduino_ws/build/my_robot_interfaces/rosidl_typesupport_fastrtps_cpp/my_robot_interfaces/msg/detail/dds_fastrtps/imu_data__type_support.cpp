...
#include "my_robot_interfaces/msg/detail/imu_data__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::msg::ImuData & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::msg::ImuData & ros_message)
{
  // Member: temperature
  cdr >> ros_message.temperature;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::msg::ImuData;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::msg::ImuData *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::msg::ImuData *>(
    untyped_ros_message);
...
{
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, msg, ImuData)() {
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_ImuData__handle;
}
