...
#include "my_robot_interfaces/msg/detail/laser_scan__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_robot_interfaces::msg::LaserScan & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_robot_interfaces::msg::LaserScan & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_robot_interfaces::msg::LaserScan;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_robot_interfaces::msg::LaserScan *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_robot_interfaces::msg::LaserScan *>(
    untyped_ros_message);
...
{
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_LaserScan__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_robot_interfaces, msg, LaserScan)() {
  return &my_robot_interfaces::msg::typesupport_fastrtps_cpp::_LaserScan__handle;
}
